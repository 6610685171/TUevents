...
#         return render(
#             request, "my_account/personal_info.html", {"student": student, "form": form}
#         )
#     else:
#         messages.warning(request, "You need to log in first.")
#         return redirect("login")
...
#     return render(
#         request, "my_account/edit_profile.html", {"form": form, "student": student}
#     )
...
#     return render(
#         request, "my_account/my_events.html", {"interested_events": interested_events}
#     )
...
#     return render(
#         request,
#         "my_account/lost_found_history.html",
#         {"lost_items": lost_items, "found_items": found_items},
#     )

# # -------------------------------
# # 7. Admin Views (เฉพาะ superuser)
# # -------------------------------
